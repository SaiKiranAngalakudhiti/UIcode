...
const Settings = ({set_pref,setStyle,pref,set_recommend_info,style,dsearch, pref_id, set_pref_id, defaultPrefIndex}) => {
    let dataComp = [];
    ...
    useEffect(() => {
        ...
        async function getpreferencesFeel() {
            try {
                const vals =[0,50,100]
                let res = await axios.get("http://52.20.201.221:4000/prefAPI/getPreferenceFeel");
        ...
        <Popover >
            ...
            <PopoverContent>
                ...
                <PopoverBody>
                    ...
                    <Tabs variant='unstyled' defaultIndex={Number(Cookie.get("default_preference_index"))}>
