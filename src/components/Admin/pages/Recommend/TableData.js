...
function TableData() {
  ...
  useEffect(() => {
    fetch("http://52.20.201.221:4000/clothCatAPI/getClothCategory")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("http://52.20.201.221:4000/clothAPI/getClothing")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("http://52.20.201.221:4000/recommendAPI/getRecommends")
      .then((res) => res.json())
      .then((data) => {
        setData(data);
      });
  ...
  // }, []);
  useEffect(() => {
    fetch("http://52.20.201.221:4000/prefAPI/getPreferenceSport")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("http://52.20.201.221:4000/prefAPI/getPreferenceFeel")
      .then((res) => res.json())
      .then((data) => {
