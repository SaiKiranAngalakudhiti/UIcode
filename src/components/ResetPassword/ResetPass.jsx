...
class ResetPass extends Component{
  ...
  async componentDidMount() {
    ...
    // } = this.props;
    try {
      const response =  await fetch('http://52.20.201.221:4000/adminAPI/reset',{
        method: 'POST',
        body: JSON.stringify({
          // Add parameters here
  ...
  updatePassword = async (e) => {
    ...
    // } = this.props;
    try {
      const response =  await fetch('http://52.20.201.221:4000/adminAPI/checkUser',{
        method: 'POST',
        body: JSON.stringify({
          // Add parameters here
          email,
      ...
      if(json.message === 'user exists in db'){
        try {
            const responseUpdate =  await fetch('http://52.20.201.221:4000/adminAPI/UpdatePassword',{
                method: 'PUT',
                body: JSON.stringify({
                // Add parameters here
