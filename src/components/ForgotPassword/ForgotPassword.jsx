    ...
    handleValidation(){
      ...
      sendEmail = async (e) => {
        ...
        if(this.handleValidation()){
          ...
          try {
              const response =  await fetch('http://52.20.201.221:4000/forgotPassAPI/checkUser',{
                method: 'POST',
                body: JSON.stringify({
                  // Add parameters here
              ...
              if(json.message == 'valid data'){
                  try {
                      const jsonUpdate =  await fetch('http://52.20.201.221:4000/forgotPassAPI/forgotPassword',{
                          method: 'PUT',
                          body: JSON.stringify({
                          // Add parameters here
                          email : this.state.fields.email
                      ...
                      // .then(response2 => {
                        ...
                        if(json2.tokenid != ""){
                          var templateParams = {
                            ...
                            + `http://52.20.201.221:3000/reset/${json2.tokenid}\n\n`
                            + 'If you did not request this, please ignore this email and your password will remain unchanged.\n',
                            reply_to: this.state.fields.email
                          };
                          //redirect here
                          emailjs.send('service_6sxwmz5', 'template_b30s8z4', templateParams, 'yirHcs6nSGzYtQUFx')
                          .then((result) => {
                            this.setState({
          ...
          //     'http://52.20.201.221:4000/testAPI',
          //     {
          //       email:this.state.fields.email,
          //     },
          //   );
      ...
      //   if(this.handleValidation()){
      //       try {
      //           const response =  await fetch('http://52.20.201.221:4000/testAPI',{
      //             method: 'POST',
      //             body: JSON.stringify({
      //               // Add parameters here
      ...
      //           if(json.message == 'valid data'){
      //               try {
      //                   const responseUpdate =  await fetch('http://52.20.201.221:4000/testAPI',{
      //                       method: 'PUT',
      //                       body: JSON.stringify({
      //                       // Add parameters here
      //                       username : this.state.fields.email,
